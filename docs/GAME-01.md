...
| 代号 | 定位 | 原型观感 | ★声线(待定) | 功能 |
|------|------|---------|------------|------|
| captain | 主角·船长 | 沉稳的领航者 | 待定 | 主操作/主线选择 |
| navigator | 舵手/引路人 | 活泼/话痨向导 | 待定 | 世界观解说、事件引导 |
| bosun | 水手长/大叔 | 憨厚可靠老兵 | 待定 | 海战指挥、冷笑话 |
| surgeon | 船医/温和者 | 冷静医者 | 待定 | 抉择中和、羁绊线 |
| enemy_galley | 敌方海盗头目 | 狡黠敌手 | 待定 | Boss 对决、主线对手 |
| + 若干 NPC | 商人/神秘岛老人/遇难者 | — | 待定 | 事件触发者 |

> 由"角色个性"反推声线（萝莉/御姐/大叔/正太等），避免反过来硬塞。

---

## 8. 首个可玩 demo（M3 里程碑验收标准）
...
- 最终名以 `The Uncharted Sea` 英文为主还是中英双语。
- 舰炮战手感参数（弹速/风速权重）首版实测再定。
- 世界地图形态（瓦片海图 vs 连续航行）→ 影响 ActionLayer 相机。
- 船员角色最终名单与声线（定角色版本后补）。
- 是否引入经济系统（贸易/补给）——影响循环密度，但不阻塞首版。
